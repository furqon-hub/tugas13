    ...
    <div class="col-md-4">
        <div class="card border-primary">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h6 class="text-muted">Anggota Sukses Aktif</h6>
                        <h2>{{ $anggotaAktif }}</h2>
                    </div>
...
{{-- Form Search di Index (Tugas 3) --}}
<div class="card mb-4 border-info">
    <div class="card-header bg-info text-white">
        <i class="bi bi-search"></i> Advanced Search & Filter Anggota
    </div>
    <div class="card-body">
